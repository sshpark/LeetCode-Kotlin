...
fun main(args: Array<String>) {
    ...
    easyFolder.maxDepth(1)
            ...
            .forEach { f ->
                ...
                readmeContents.add(Pair(id.toInt(), "| $id | $leetcodeLink | [Kotlin]($f) | Easy |\n"))
            }
    ...
    mediumFolder.maxDepth(1)
            ...
            .forEach { f ->
                ...
                val title = name.substring(firstDotIndex+1, name.length-3)
                val leetcodeLink = "[$title](https://leetcode.com/problems/$title/description/)"
                readmeContents.add(Pair(id.toInt(), "| $id | $leetcodeLink | [Kotlin]($f) | Medium |\n"))
            }
    ...
    hardFolder.maxDepth(1)
            ...
            .forEach { f ->
                ...
                val title = name.substring(firstDotIndex+1, name.length-3)
                val leetcodeLink = "[$title](https://leetcode.com/problems/$title/description/)"
                readmeContents.add(Pair(id.toInt(), "| $id | $leetcodeLink | [Kotlin]($f) | Hard |\n"))
            }
